...
console.log("Isi dari presensiRecords adalah:", presensiRecords);
console.log("Tipe datanya adalah:", typeof presensiRecords);
console.log("Apakah ini array?:", Array.isArray(presensiRecords));
console.log("-----------------");
